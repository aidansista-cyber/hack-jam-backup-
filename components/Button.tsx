...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
    variant?: 'primary' | 'secondary' | 'danger' | 'ghost' | 'annoying';
    isLoading?: boolean;
}
...
export const Button: React.FC<ButtonProps> = ({ 
    ...
    const variants = {
        ...
        // USF Themed: Green background, Gold text, Gold border
        annoying: "bg-green-900 text-[#e5c511] font-comic-sans hover:bg-green-800 border-4 border-dashed border-[#e5c511] transform hover:rotate-2 active:scale-95 shadow-lg"
    };
